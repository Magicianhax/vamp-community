...
export function ResourceRow({ resource, rank, userId, isExpanded, onToggle }: ResourceRowProps) {
  ...
  const handleCardClick = (e: React.MouseEvent) => {
    // Don't toggle if clicking on vote buttons or the visit button
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 sm:gap-4 p-3 sm:p-4">
        ...
        {/* Expand indicator and Vote buttons */}
              ...
              <div className="pt-2" data-no-toggle>
                ...
                >
                  <Button size="sm" className="w-full sm:w-auto">
                    {isInternalArticle ? 'Read Article' : 'Visit Website'}
