    ...
    <Card className="flex items-center gap-4 p-4 w-full box-border overflow-hidden">
      ...
      <div className="flex-shrink-0">
        {project.thumbnail_url ? (
          <div className="w-12 h-12 border-2 border-black shadow-md overflow-hidden">
            <Image
          ...
          <div className="w-12 h-12 border-2 border-black shadow-md bg-primary flex items-center justify-center">
            <span className="text-lg font-head font-bold text-primary-foreground">{project.title[0]}</span>
          </div>
        )}
      </div>
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        <ProjectVoteButtons
          ...
          size="sm"
        />
        <Link href={`/projects/${project.id}#comments`} className="flex-shrink-0">
